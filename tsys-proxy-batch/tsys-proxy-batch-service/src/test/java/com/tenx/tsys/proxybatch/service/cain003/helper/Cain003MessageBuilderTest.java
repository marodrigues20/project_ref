...
public class Cain003MessageBuilderTest {

  private static final String CAIN003_RESPONSE = "response/cain003-transaction-message.json";
  ...
  @Test
  public void setTransactionMessage_ShouldReturnCAIN003MessageType_WhenValidData()
      throws ParseException {
    TransactionMessage transactionMessage = new TransactionMessage();
    Map<String, Object> expectedMessageMap = generateMessageMapData();
    DebitCardResponse debitCardResponse = buildDebitCardResponse();
    ...
    assertEquals(paymentMessage.getType(), PaymentMessageTypeEnum.CAIN003.name());
  }

  @Test
  public void setTransactionMessage_ShouldReturnCAIN003MessageBody_WhenValidData()
      throws Exception {
    TransactionMessage transactionMessage = new TransactionMessage();
    Map<String, Object> expectedMessageMap = generateMessageMapData();
    DebitCardResponse debitCardResponse = buildDebitCardResponse();
    when(cainIsoMapBuilder.buildMessageMap(validRawData, unit.getMessageDataPositionList()))
        .thenReturn(expectedMessageMap);
    unit.setTransactionMessage(transactionMessage, validRawData, debitCardResponse);
    assertThat(FileUtility.getFileContent(CAIN003_RESPONSE))
        .isEqualTo(JsonUtils.jsonToString(transactionMessage));
  }
//  check sub key &Add Info

  @Test
  public void setTransactionMessage_ShouldReturnCAIN003AdditionalInfo_WhenValidData()
      throws ParseException {
    TransactionMessage transactionMessage = new TransactionMessage();
    Map<String, Object> expectedMessageMap = generateMessageMapData();
    DebitCardResponse debitCardResponse = buildDebitCardResponse();
  ...
  @Test
  public void setTransactionMessage_ShouldReturnCAIN003SubscriptionKey_WhenValidData()
      throws ParseException {
    TransactionMessage transactionMessage = new TransactionMessage();
    Map<String, Object> expectedMessageMap = generateMessageMapData();
    DebitCardResponse debitCardResponse = buildDebitCardResponse();
  ...
  private Map<String, Object> generateMessageMapData() {
    ...
    expectedMessageMap.put(Cain003Enum.CARD_ACCEPTOR_STATE.name(), "123");
    expectedMessageMap.put(Cain003Enum.CASH_BACK_INDICATOR.name(), "1");
    expectedMessageMap.put(Cain003Enum.CARD_ACCEPTOR_TERMINAL_ID.name(), "12345678");
    expectedMessageMap.put(Cain003Enum.MERCHANT_CATEGORY_CODE.name(), "DE26");
