...
public class Cain003PaymentServiceTest {

  private final String subscriptionKey = "TEST_SUBSCRIPTION_KEY";
  private final String productKey = "TEST_PRODUCT_KEY";
  private String testData;
  @InjectMocks
  private Cain003PaymentService unit;
  @Mock
  private Cain003MessageBuilder cain003MessageBuilder;

  @Before
  public void buildTsysAceServiceInputData() throws ParseException {
    testData = "";
  }

  @Test
  public void buildMessageTest_Return_NotNUllResult_WhenSuccess() throws java.text.ParseException {
    ...
    when(cain003MessageBuilder.setTransactionMessageHeader(transactionMessage))
        .thenReturn(transactionMessage);
    when(cain003MessageBuilder
        .setTransactionMessage(transactionMessage, testData, debitCardResponse))
        .thenReturn(transactionMessage);
    unit.buildMessage(testData, debitCardResponse);
    assertNotNull(transactionMessage);
  }

  @Test
  public void buildMessageTest_Return_Header_AndMessage_WhenSuccess()
