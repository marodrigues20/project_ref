...
import static com.tenx.universalbanking.transactionmessage.enums.Cain005Enum.BILLING_AMOUNT;
import static com.tenx.universalbanking.transactionmessage.enums.Cain005Enum.BILLING_CURRENCY_CODE;
import static com.tenx.universalbanking.transactionmessage.enums.Cain005Enum.CARDHOLDER_PRESENT;
import static com.tenx.universalbanking.transactionmessage.enums.Cain005Enum.CARDHOLER_PRESENT;
import static com.tenx.universalbanking.transactionmessage.enums.Cain005Enum.CARD_ACCEPTOR_CITY;
import static com.tenx.universalbanking.transactionmessage.enums.Cain005Enum.CARD_ACCEPTOR_COUNTRY_CODE;
import static com.tenx.universalbanking.transactionmessage.enums.Cain005Enum.CARD_ACCEPTOR_ID;
import static com.tenx.universalbanking.transactionmessage.enums.Cain005Enum.CARD_ACCEPTOR_NAME;
import static com.tenx.universalbanking.transactionmessage.enums.Cain005Enum.CARD_ACCEPTOR_STATE;
import static com.tenx.universalbanking.transactionmessage.enums.Cain005Enum.CARD_ACCEPTOR_TERMINAL_ID;
import static com.tenx.universalbanking.transactionmessage.enums.Cain005Enum.CARD_DATA_ENTRY_MODE;
import static com.tenx.universalbanking.transactionmessage.enums.Cain005Enum.CASH_BACK_AMOUNT;
import static com.tenx.universalbanking.transactionmessage.enums.Cain005Enum.CASH_BACK_INDICATOR;
import static com.tenx.universalbanking.transactionmessage.enums.Cain005Enum.COMMON_COUNTRY_CODE;
import static com.tenx.universalbanking.transactionmessage.enums.Cain005Enum.EXCHANGE_RATE;
import static com.tenx.universalbanking.transactionmessage.enums.Cain005Enum.MERCHANT_CATEGORY_CODE;
import static com.tenx.universalbanking.transactionmessage.enums.Cain005Enum.MERCHANT_NUMBER;
import static com.tenx.universalbanking.transactionmessage.enums.Cain005Enum.RECURRING_PAYMENT_INDICATOR;
import static com.tenx.universalbanking.transactionmessage.enums.Cain005Enum.TOKENISED_PAN;
import static com.tenx.universalbanking.transactionmessage.enums.Cain005Enum.TRANSACTION_AMOUNT;
import static com.tenx.universalbanking.transactionmessage.enums.Cain005Enum.TRANSACTION_AMOUNT_QUALIFIER;
import static com.tenx.universalbanking.transactionmessage.enums.Cain005Enum.TRANSACTION_DATE;
import static com.tenx.universalbanking.transactionmessage.enums.Cain005Enum.TRANSACTION_POSTED_DATE;
import static com.tenx.universalbanking.transactionmessage.enums.Cain005Enum.TRANSACTION_POSTED_TIME;
...
@Component
public class Cain005MessageBuilder {
  ...
  public TransactionMessage setTransactionMessage(TransactionMessage transactionMessage,
    ...
    message.setType(PaymentMessageTypeEnum.CAIN005.name());
    Map<String, Object> messageMap = generateDebitCardPaymentCain005Message(rawMessage,
        getMessageDataPositionList());
    messageMap.put(TRANSACTION_AMOUNT_QUALIFIER.name(), ACTL);
    message.setMessage(messageMap);
    Map<String, Object> messageAdditionalMap = generateDebitCardPaymentCain005Message(rawMessage,
        getAdditionalInfoDataPositionList());
    messageAdditionalMap.put(DEBIT_CREDIT_INDICATOR.name(), CREDIT);
    paymentMethodProvider.setPaymentMethodType(messageMap, messageAdditionalMap);
    message.setAdditionalInfo(messageAdditionalMap);
    setSubscriptionKeyAndProductKey(debitCardResponse, message);
  ...
  private void setSubscriptionKeyAndProductKey(DebitCardResponse debitCardResponse,
  ...
  public Map generateDebitCardPaymentCain005Message(String message,
