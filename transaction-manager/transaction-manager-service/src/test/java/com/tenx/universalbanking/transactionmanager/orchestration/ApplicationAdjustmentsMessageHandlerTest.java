...
public class ApplicationAdjustmentsMessageHandlerTest {
  ...
  @InjectMocks
  private ApplicationAdjustmentsMessageHandler applicationAdjustmentsMessageHandler;

  @Mock
  private TransactionServiceFactory factory;

  @Mock
  private ApplicationAdjustmentsService applicationAdjustmentsService;
  ...
  public void shouldAddTransactionIdToMessage() throws Exception {
    ...
    applicationAdjustmentsMessageHandler.handleMessage(getTransactionMessage());
  ...
  public void handlesMessageOfCorrectType() {
    assertThat(applicationAdjustmentsMessageHandler.handlesMessageOfType()).isEqualTo(APPLICATION_ADJUSTMENTS);
  }
  ...
  private TransactionMessage getTransactionMessage() {
    ...
    header.setType(APPLICATION_ADJUSTMENTS.name());
  ...
  private void mockLMPosting(String reponse) throws Exception{
    ...
    when(applicationAdjustmentsService.process(any(), any())).thenReturn(buildPaymentProcessResponse(reponse));
  }
