...
public class CardAuthRestTest extends BaseComponentTest {

  private static final String AUTHORISATION_JSON = "/json/authorisation.json";
  private static final String ENDPOINT = "/api/v1/transactions/authorisation";
  ...
  @Test
  public void successfulCardAuth() throws Exception {
    ...
    assertThat(cashTransactionEntities)
        ...
        .containsExactlyInAnyOrder(AUTH);
  ...
  @Test
  public void reserveFailedCardAuth() throws Exception {
    givenACardWithPanHash();
    givenASubscriptionForCard();
    givenLedgerReserveResponse(true);
    stubPostReserve(new ReserveResponse(BigDecimal.valueOf(1), false));
  ...
  private HttpEntity<String> buildEntity() {
    ...
    return new HttpEntity<>(FileUtils.readFile(AUTHORISATION_JSON), headers);
  }
