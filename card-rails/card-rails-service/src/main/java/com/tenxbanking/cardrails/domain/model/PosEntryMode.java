...
public enum PosEntryMode {
  ...
  public static Map<String, String> posEntryMap = (Map) Arrays.stream(values()).collect(Collectors.toMap(PosEntryMode::getPosCode, PosEntryMode::getCainCode));

  PosEntryMode(String posCode, String cainCode) {
